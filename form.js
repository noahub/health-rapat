...
$(".submit").click((e) => {
	...
	sessionStorage.setItem("budget", $("#budget").val());
	sessionStorage.setItem("process", $("#process").val());
	sessionStorage.setItem("evaluate", $("#evaluate").val());
	sessionStorage.setItem("question1", $("#question1").val());
	sessionStorage.setItem("question2", $("#question2").val());
	sessionStorage.setItem("question3", $("#question3").val());
	sessionStorage.setItem("question4", $("#question4").val());
